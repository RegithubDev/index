                  ...
                  <ul>
                    <li>
                      <a href="#" class="flex h-8 items-center space-x-3 px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mt-px h-4.5 w-4.5" fill="none" viewBox="0 0 24 24" stroke="#e21e26" stroke-width="2">
          ...
          <div class="card items-center justify-between lg:flex-row">
            <div class="flex flex-col items-center p-4 text-center sm:p-5 lg:flex-row lg:space-x-4 lg:text-left">
              <div class="avatar h-18 w-18 lg:h-12 lg:w-12">
               <!--  <img class="rounded-full" src="/index/resources/images/avatar/avatar-20.jpg" alt="avatar"> -->
                <svg xmlns="http://www.w3.org/2000/svg" class=" rounded-full inline  w-16 text-secondary dark:text-secondary-light" fill="none" viewBox="0 0 24 24" stroke="#e21e26">
              ...
              <div class="mt-2 lg:mt-0">
                <div class="flex space-x-1">
                  ...
                  <button class="btn hidden h-6 rounded-full px-2 text-xs font-medium text-re hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25 lg:inline-flex">
                     ${obj.base_department }
                  </button>
                </div>
                <p class="text-xs+"><i class="fa fa-envelope" aria-hidden="true"></i> ${obj.email_id }<br><i class="fa fa-phone" aria-hidden="true"></i> ${obj.contact_number }<br>
                </p>
                <p> <img class="h-full w-5 object-cover object-top" src="/index/resources/images/avatar/reportingTo.svg" alt="" style="display: initial;"> ${obj.reporting_to }</p>
              </div>
