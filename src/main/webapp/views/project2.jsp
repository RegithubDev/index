     ...
     <main class="main-content w-full p-6 pb-8">
       ...
       Project
          ...
          <ul class=" flex-wrap items-center space-x-2 sm:flex">
            ...
            <li class="hidden sm:flex">Project</li>
          </ul>
          ...
          <label class="block">
                  <select id="select2-company_filter-container"  onchange="getDepartmentfilter();" class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                    <option value="">Select Company</option>
                   	
                  </select>
                </label>
                   <label class="block">
                  <select id="select2-sbu_filter-container"  onchange="getDepartmentfilter();" class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                    <option value="">Select SBU</option>
                   	
                  </select>
                </label>
                 <label class="block">
                  <select id="select2-project_filter-container"  onchange="getDepartmentfilter();" class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
       ...
       id="select2-company_code_add-container"              
		name="status" 
                   class=" select2 form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 
                   hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 
		     ...
		     <div class="card invoice-list-wrapper">
		      <div class="card-datatable table-responsive">
		       <div class="dt-buttons" style="height : 0.5em;">
                ...
                <table class="invoice-list-table table is-zebra w-full text-left" id="datatable-project">
                  <thead>
                    <tr>
       ...
       <button style="display : none"; @click="showModal = true" id="updateModal" class="btn bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent 
        ...
        <form id="updateCompanyForm" class="row gy-1 pt-75" action="<%=request.getContextPath() %>/update-project" method="post" class="form-horizontal" role="form" >
             ...
             <span id="select2-company_code_edit-containerError" class="error-msg" ></span>
                     ...
                     <label class="block  text-left">
                    <span>SBU</span><span class="required"> *</span><br>
                  <select
                  id="select2-sbu_code_edit-container"
              name="sbu_code"
                   class=" select2 form-select3 form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent" style="
    width: 12rem;
">
                    <option value="">Select SBU</option>
             	<c:forEach var="obj" items="${sbuList}">
             ...
             <span id="project_name_editError" class="error-msg" ></span>
              ...
              name="status"
                   class=" select2 form-select3 form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                    <option value="">Select Status</option>
             	<option value="Active">Active</option>
             	<option value="Inactive">Inactive</option>
                  </select>
      ...
      function getSBUFilterList() {
	    ...
	    function getCompanyList(){
    		...
    		$('#inActiveProjects').html(0)
	     	table = $('#datatable-project').DataTable();
			table.destroy();
	    ...
	    function getProject(project_code,status,p_name,id,c_code,s_code,c_name,s_name){
			 ...
			 $('select[name^="sbu_code"] option:selected').removeAttr("selected");
		      ...
		      $('#updateCompanyForm #project_code_edit').val($.trim(project_code)).focus();
