...
.received {
  ...
  <div class="chat-container">
    <div class="chat-header" onclick="minimizeChat()">
        ...
        <span class="close-btn" onclick="closeChat()"><i class="fa-solid fa-minimize"></i></span>
    </div>
    ...
    <!-- Scroll buttons -->
    <button class="scroll-btn" onclick="scrollToTop()"><i class="fa fa-chevron-up"></i></button>
    <button class="scroll-btn" onclick="scrollToBottom()"><i class="fa fa-chevron-down"></i></button>
</div>
 ...
 <script src="/index/resources/js/jquery-validation-1.19.1.min.js"  ></script>
    ...
    <script>
     ...
     function receiveMessage(val) {
    	 ...
    	 if ($.trim(PO_Number) !== "") {
    	   var myParams = { PO_Number: PO_Number };
    	   $.ajax({
