...
<head>
  ...
  <title>RE - SignUp</title>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" href="/index/resources/vendor/css/pages/page-auth.css">
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
   ...
   <link rel="stylesheet" type="text/css" href="/index/resources/vendors/css/forms/select/select2.min.css">
    ...
    <!-- END: Page CSS-->
      <link rel="stylesheet" type="text/css" href="/index/resources/vendors/css/file-uploaders/dropzone.min.css">
    <link rel="stylesheet" type="text/css" href="/index/resources/css/plugins/forms/form-file-uploader.min.css">
    <!-- BEGIN: Custom CSS-->
...
<div class="col-lg-12 col-sm-12 col-12" style="box-sizing:border-box; display:table;">
 ...
 <script src="/index/resources/js/materialize-v.1.0.min.js "  ></script>
   ...
   <script src="/index/resources/js/scripts/pages/modal-add-new-cc.min.js"></script>
    ...
    <script src="/index/resources/vendors/js/file-uploaders/dropzone.min.js"></script>
    <script src="/index/resources/js/scripts/forms/form-file-uploader.min.js"></script>
