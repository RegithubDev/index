...
@keyframes enlarge{
        ...
        <!-- Sidebar Panel -->
          ...
          >
            ...
            <div class="flex h-18 w-full items-center justify-between pl-4 pr-1">
              ...
              <button @click="$store.global.isSidebarExpanded2 = false" class="btn h-7 w-7 rounded-full p-0 text-primary hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:text-accent-light/80 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 xl:hidden">
          ...
          >
            ...
            <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
              <div class="is-scrollbar-hidden grow overflow-y-auto">
                ...
                <div x-data="{expanded:true}">
                  <div class="mt-4 flex items-center justify-between px-4">
                    <span class="text-xs font-medium uppercase">Departments 1</span>
                    <div class="-mr-1.5 flex">
                      <button
                        @click="expanded =! expanded"
                        class="btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
 ...
 href="<%=request.getContextPath() %>/F&A"
      ...
      <!-- Right Sidebar -->
      <div
        x-show="$store.global.isSidebarExpanded1"
        @keydown.window.escape="$store.global.isSidebarExpanded1 = false"
      >
        <div
          class="fixed inset-0 z-[150] bg-slate-900/60 transition-opacity duration-200"
          @click="$store.global.isSidebarExpanded1 = false"
          x-show="$store.global.isSidebarExpanded1"
        ...
        ></div>
        <div class="fixed top-0 z-[151] h-full w-full sm:w-80">
          <div
          ...
          >
            <div class="flex items-center justify-between py-2 px-4">
              ...
              >
                <span class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">IT Functions</span>
              </p>
        ...
        >
          ...
          <div class="flex w-full items-center justify-between">
            ...
            <button
               ...
               :class="$store.global.isSidebarExpanded2 &amp;&amp; 'active'" @click="$store.global.isSidebarExpanded2 = !$store.global.isSidebarExpanded2"
              >
                <span></span>
                <span></span>
                <span></span>
...
"> <img class="h-20 w-1w" src="/index/resources/images/avatar/get-newsletter-updates.svg" alt="image">
    ...
    width: 13rem;">
              <div class="flex w-full items-center justify-center rounded-lg dark:bg-navy-500 text-center">
               <br> <br> <br><br> <p class=" text-xl font-medium text-slate-700  active:bg-slate-300/25 dark:text-navy-100 dark:hover:bg-navy-300/20 dark:active:bg-navy-300/25">${sessionScope.DEPARTMENT_NAME }</p>
              </div>
