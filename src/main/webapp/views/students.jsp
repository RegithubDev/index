...
<head>
    ...
    <title>PurpleWest - Students</title>
...
<div x-data="usePopper({placement:'right-end',offset:12})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="flex">
            ...
            <div class="flex items-center justify-between">
              <h2 class="text-base font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100">
                ...
                <div class="flex items-center" >
                  <a href="<%=request.getContextPath() %>/add-new-student" class="btn bg-info font-medium text-white hover:bg-info-focus focus:bg-info-focus active:bg-info-focus/90">
		     ...
		     <div class="card invoice-list-wrapper">
		      <div class="card-datatable table-responsive">
		       <div class="dt-buttons" style="height : 0.5em;">
                ...
                <table class="invoice-list-table table is-zebra w-full text-left" id="studentsTable">
                  <thead>
                    <tr>
    ...
    <script>
      ...
      function getUser(user_id){
      	$("#user_id").val(user_id);
      	$('#getForm').attr('action', '<%=request.getContextPath()%>/update-student');
      	$('#getForm').submit();
      }
      function getStudentsList(){
			...
			table.state.clear();		
		 	var myParams = {};
			$.ajax({url : "<%=request.getContextPath()%>/ajax/getStudentsList",type:"POST",data:myParams,success : function(data){    				
					if(data != null && data != '' && data.length > 0){    					
		         		$.each(data,function(key,val){
		                	...
		                	rowArray.push($.trim(val.credits));
