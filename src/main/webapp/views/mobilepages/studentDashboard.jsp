        ...
        <div class="main-sidebar">
          ...
          >
            ...
            <div class="flex pt-4">
              <a href="<%=request.getContextPath() %>/home">
                <img
                  ...
                  src="/courses/resources/images/app-logo.png"
                  alt="logo"
                />
              </a>
            </div>
            ...
            >
              ...
              <!-- Apps -->
              <a
                href="<%=request.getContextPath() %>/teachers-list"
                class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                x-tooltip.placement.right="'Teachers'"
              >
                <svg
                  class="h-7 w-7"
                  viewBox="0 0 24 24"
              ...
              <a
                ...
                class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                x-tooltip.placement.right="'Students'"
              >
                <svg
                  class="h-7 w-7"
                  viewBox="0 0 24 24"
              ...
              <!-- Forms -->
              <a
                href="<%=request.getContextPath() %>/courses-list"
                class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                x-tooltip.placement.right="'Courses'"
              >
                <svg
                  class="h-7 w-7"
                  viewBox="0 0 24 24"
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              <div x-data="usePopper({placement:'right-end',offset:12})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="flex">
                ...
                <div :class="isShowPopper &amp;&amp; 'show'" class="popper-root fixed" x-ref="popperRoot" style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(76px, 38px);" data-popper-placement="right-end">
                  <div class="popper-box w-64 rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-600 dark:bg-navy-700">
                    ...
                    <div class="flex flex-col pt-2 pb-5">
                      ...
                      <div class="mt-3 px-4">
                        <a href="<%=request.getContextPath() %>/logout" class="btn h-9 w-full space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-7897efa45886d736" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
              <div class="card swiper-slide flex w-72 shrink-0 justify-between rounded-xl border-l-4 border-primary p-4 swiper-slide-active" role="group" aria-label="1 / 6" style="margin-right: 18px;">
                <div>
                  ...
                  <a href="#" class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Konnor Guzman</a>
                </div>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
          <div class="card col-span-12 pb-3 lg:col-span-6">
            ...
            <div class="course-schedule-chart pr-2">
              <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.courseTimeline); $el._x_chart.render() });" style="min-height: 200px;"><div id="apexchartskp83nbwk" class="apexcharts-canvas apexchartskp83nbwk apexcharts-theme-light" style="width: 551px; height: 200px;"><svg id="SvgjsSvg1171" width="551" height="200" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev" class="apexcharts-svg apexcharts-zoomable" xmlns:data="ApexChartsNS" transform="translate(0, 0)" style="background: transparent;"><g id="SvgjsG1173" class="apexcharts-inner apexcharts-graphical" transform="translate(27, 14)"><defs id="SvgjsDefs1172"><clipPath id="gridRectMaskkp83nbwk"><rect id="SvgjsRect1197" width="518" height="146.73" x="-2" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect></clipPath><clipPath id="forecastMaskkp83nbwk"></clipPath><clipPath id="nonForecastMaskkp83nbwk"></clipPath><clipPath id="gridRectMarkerMaskkp83nbwk"><rect id="SvgjsRect1198" width="518" height="150.73" x="-2" y="-2" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fff"></rect></clipPath></defs><line id="SvgjsLine1177" x1="0" y1="0" x2="0" y2="146.73" stroke-dasharray="3" stroke-linecap="butt" class="apexcharts-xcrosshairs" x="0" y="0" width="1" height="146.73" fill="#b1b9c4" filter="none" fill-opacity="0.9" stroke-width="0"></line><line id="SvgjsLine1218" x1="9.252" y1="147.73" x2="9.252" y2="153.73" stroke="#e0e0e0" stroke-dasharray="0" stroke-linecap="butt" class="apexcharts-xaxis-tick"></line><line id="SvgjsLine1220" x1="64.76400000000001" y1="147.73" x2="64.76400000000001" y2="153.73" stroke="#e0e0e0" stroke-dasharray="0" stroke-linecap="butt" class="apexcharts-xaxis-tick"></line
excharts-yaxis-texts-g apexcharts-xaxis-inversed-texts-g" transform="translate(0, 0)"></g></g><g id="SvgjsG1248" class="apexcharts-xaxis apexcharts-yaxis-inversed"><g id="SvgjsG1249" class="apexcharts-xaxis-texts-g" transform="translate(0, -8)"><text id="SvgjsText1251" font-family="Helvetica, Arial, sans-serif" x="9.252" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1253">27 Feb</tspan><title>27 Feb</title></text><text id="SvgjsText1255" font-family="Helvetica, Arial, sans-serif" x="64.76400000000001" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1257">Mar '19</tspan><title>Mar '19</title></text><text id="SvgjsText1259" font-family="Helvetica, Arial, sans-serif" x="120.27600000000001" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1261">03 Mar</tspan><title>03 Mar</title></text><text id="SvgjsText1263" font-family="Helvetica, Arial, sans-serif" x="175.788" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1265">05 Mar</tspan><title>05 Mar</title></text><text id="SvgjsText1267" font-family="Helvetica, Arial, sans-serif" x="231.3" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1269">07 Mar</tspan><title>07 Mar</title></text><text id="SvgjsText1271" font-family="Helvetica, Arial, sans-serif" x="286.812" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1273">09 Mar</tspan><title>09 Mar</title></text><text id="SvgjsText1275" font-family="Helvetica, Arial, sans-serif" x="342.32399999999996" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1277">11 Mar</tspan><title>11 Mar</title></text><text id="SvgjsText1279" font-family="Helvetica, Arial, sans-serif" x="397.8359999999999" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1281">13 Mar</tspan><title>13 Mar</title></text><text id="SvgjsText1283" font-family="Helvetica, Arial, sans-serif" x="453.34799999999984" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1285">15 Mar</tspan><title>15 Mar</title></text><text id="SvgjsText1287" font-family="Helvetica, Arial, sans-serif" x="508.8599999999998" y="176.73" text-anchor="middle" dominant-baseline="auto" font-size="12px" font-weight="400" fill="#373d3f" class="apexcharts-text apexcharts-xaxis-label " style="font-family: Helvetica, Arial, sans-serif;"><tspan id="SvgjsTspan1289"></tspan><title></title></text></g></g><rect id="SvgjsRect1294" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe" class="apexcharts-zoom-rect"></rect><rect id="SvgjsRect1295" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe" class="apexcharts-selection-rect"></rect></g><rect id="SvgjsRect1176" width="0" height="0" x="0" y="0" rx="0" ry="0" opacity="1" stroke-width="0" stroke="none" stroke-dasharray="0" fill="#fefefe"></rect><g id="SvgjsG1174" class="apexcharts-annotations"></g></svg><div class="apexcharts-legend" style="max-height: 100px;"></div><div class="apexcharts-tooltip apexcharts-theme-light"><div class="apexcharts-tooltip-title" style="font-family: Helvetica, Arial, sans-serif; font-size: 12px;"></div><div class="apexcharts-tooltip-series-group" style="order: 1;"><span class="apexcharts-tooltip-marker" style="background-color: rgb(0, 143, 251);"></span><div class="apexcharts-tooltip-text" style="font-family: Helvetica, Arial, sans-serif; font-size: 12px;"><div class="apexcharts-tooltip-y-group"><span class="apexcharts-tooltip-text-y-label"></span><span class="apexcharts-tooltip-text-y-value"></span></div><div class="apexcharts-tooltip-goals-group"><span class="apexcharts-tooltip-text-goals-label"></span><span class="apexcharts-tooltip-text-goals-value"></span></div><div class="apexcharts-tooltip-z-group"><span class="apexcharts-tooltip-text-z-label"></span><span class="apexcharts-tooltip-text-z-value"></span></div></div></div></div><div class="apexcharts-yaxistooltip apexcharts-yaxistooltip-0 apexcharts-yaxistooltip-left apexcharts-theme-light"><div class="apexcharts-yaxistooltip-text"></div></div></div></div>
            </div>
          </div>
