...
<head>
    ...
    <title>PurpleWest - Student</title>
      ...
      <main class="main-content w-full p-6 pb-8">
          ...
          <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            <li class="flex items-center space-x-2">
              <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="<%=request.getContextPath() %>/students-list">Students</a>
          ...
          <div class="col-span-12 sm:col-span-10">
            <div class="card p-4 sm:p-5">
              <p class="text-base font-medium text-slate-700 dark:text-navy-100">
               <i class="fas fa-graduation-cap"></i>  - [${userDetails.user_id }]
              </p>
    ...
    <%--             <div id="toggleDiv" >
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                  <label class="block sm:col-span-8">
                    ...
                    <span class="relative mt-1.5 flex">
                      ...
                      <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                       ...
                       <span id="email_idError" class="error-msg"><label id="email_id-error" class="my-error-class" for="email_id"></label></span>
                  </label>
                   <label class="block sm:col-span-2">
                    <span>Gender </span><span class="required"> *</span>
                    <select class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 
                    focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent" 
                    name="gender" id="gender" onchange="checkAvailability();">
                  ...
                  <label class="block sm:col-span-2">
                    ...
                    <div class="relative mt-1.5 flex">
                      <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 
                      hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" 
                      placeholder="Pincode" type="text" name="pin_code" id="pincode" value="${userDetails.pin_code }">
                      <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                ...
                <label class="block">
                  ...
                  dark:focus:border-accent">${userDetails.address }</textarea></label>
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-12">
                  <label class="block sm:col-span-8">
                   ...
                   <label class="block sm:col-span-2">
                     <span>Current Credits</span><span class="required"> </span>
                    <span class="relative mt-1.5 flex">
                      <input type="hidden"  name="credits" id="credits" value="${userDetails.credits }">
                      <span >
                        <i class="fa-solid fa-credit-card"></i>&nbsp;${userDetails.credits }
                      </span>
                    </span>
                  </label>
                  <label class="block sm:col-span-2">
                     <span>Add Credits</span><span class="optional"> (optional)</span>
                    <span class="relative mt-1.5 flex">
                      <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 
                      placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                        name="credits_new" id="credits_new"  >
                      <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
