  ...
  <body x-data class="is-header-blur" x-bind="$store.global.documentBody">
     ...
     <main class="main-content w-full p-6 pb-8">
       ...
       <div class="flex items-center space-x-4 py-5 lg:py-6 p-6">
          ...
          <ul class=" flex-wrap items-center space-x-2 sm:flex">
            ...
            <li class="hidden sm:flex">User</li>
          </ul>
      ...
      <div class="p-4 sm:p-5">
          ...
          <label class="block">
                  ...
                  <label class="block">
                  <select id="select2-role_filter-container" onchange="getStatusfilter();" class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                ...
                <label class="block">
                 ...
                 <label class="block">
                  <select id="select2-time_period_filter-container" onchange="getStatusfilter();" class="form-select mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
    ...
    color: black;" placeholder="eg : email@gmail.com"   type="text">
             ...
             <span id="email_addError" class="error-msg" ></span>
                  ...
                  <label class="block  text-left">
                    <span>User Reporting To</span><span class="required"> </span>
                  <select
    ...
    color: black;">
        ...
        <form id="addCompanyForm" class="row gy-1 pt-75" action="<%=request.getContextPath() %>/add-user" method="post" class="form-horizontal" role="form" >
             ...
             <span id="email_addError" class="error-msg" ></span>
              ...
              <option value="Inactive">Inactive</option>
                ...
                <button onclick="exportUser();" class="btn bg-primary font-medium text-white hover:bg-primary-focus
                 focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"
        ...
        <div class="avatar bg-light-danger p-50 m-0">
            <div class="avatar-content">
              <svg style="width: 5rem;height: 2rem;" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity font-medium-5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
            </div> 
          </div>
                </div>
                <p class="mt-1 text-xs+">Days Logged In</p>
           </div>
            <div class=" card  rounded-lg  p-4 dark:bg-navy-600">
                <div class="flex justify-between space-x-1">
                  <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
            ...
            <div class="avatar-content">
              <svg style="width: 5rem;height: 2rem;" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity font-medium-5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                ...
                <p class="mt-1 text-xs+">Hours Spent</p>
           </div>
            <div class=" card  rounded-lg  p-4 dark:bg-navy-600">
                <div class="flex justify-between space-x-1">
                  <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
    ...
    <div class="avatar bg-light-danger p-50 m-0">
            <div class="avatar-content">
              <svg style="width: 5rem;height: 2rem;" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity font-medium-5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                ...
                <p class="mt-1 text-xs+"> Active Users</p>
           </div>
           <div class=" card  rounded-lg  p-4 dark:bg-navy-600">
                <div class="flex justify-between space-x-1">
                  <p class="text-xl font-semibold text-slate-700 dark:text-navy-100">
          ...
          <div class="avatar bg-light-danger p-50 m-0">
            <div class="avatar-content">
              <svg style="width: 5rem;height: 2rem;" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity font-medium-5"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
                ...
                <p class="mt-1 text-xs+"> Inactive Users</p>
           </div>
