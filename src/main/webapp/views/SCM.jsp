...
<body x-data class="is-header-blur is-sidebar-open"
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round"
					...
					<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
						<div class="is-scrollbar-hidden grow overflow-y-auto">
                          ...
                          <path stroke-linecap="round"
                            ...
                            <path stroke-linecap="round"
										...
										<li><a
											...
											href="<%=request.getContextPath() %>/ ">
												<svg xmlns="http://www.w3.org/2000/svg"
													class="h-4.5 w-4.5 text-warning" fill="none"
                            ...
                            <path stroke-linecap="round"
										...
										<li><a
											...
											href="<%=request.getContextPath() %>/ ">
												<svg xmlns="http://www.w3.org/2000/svg"
													class="h-4.5 w-4.5 text-info" fill="none"
													viewBox="0 0 24 24" stroke="#e21e26" stroke-width="1.5">
                            <path stroke-linecap="round"
														stroke-linejoin="round"
														d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                          </svg> <span>Procedures</span>
										</a></li>
										<li><a
											class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                         ...
                         ">
												<svg xmlns="http://www.w3.org/2000/svg"
													class="h-4.5 w-4.5 text-success" fill="none"
													viewBox="0 0 24 24" stroke="#e21e26" stroke-width="1.5">
                            <path stroke-linecap="round"
														stroke-linejoin="round"
														d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            ...
                            <path stroke-linecap="round"
														stroke-linejoin="round"
														d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                          </svg> <span>Trainig calender</span>
										</a></li>
										<li><a
											class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                            ...
                            <path stroke-linecap="round"
														stroke-linejoin="round"
														d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                          </svg> <span>Finance&Accounts</span>
										</a></li>
										<li><a
											class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
...
<div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                ...
                <div x-data="{expanded:true}">
                  ...
                  <div x-show="expanded" x-collapse>
                    ...
                    >
                          ...
                          <c:if test="${obj.department_code eq 'SCM' }">
                      <li>
                        <a
                          class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                           href="<%=request.getContextPath() %>/Admin"
		...
		<div x-show="$store.global.isRightSidebarExpanded"
			...
			<div class="fixed inset-0 z-[150] transition-opacity duration-200"
		...
		<main
			...
			<div
				class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 mt-4">
				<div class="card flex-row justify-between space-x-2 ">
					...
					<div
						class=" swiper-slide w-24 shrink-0 cursor-pointer swiper-slide-active"
						@click="selected = 'slide-8'" role="group" aria-label="1 / 16"
						style="margin-right: 14px;">
						<a id="iconsCLass" href="#"
							class="flex flex-col items-center rounded-lg px-2 py-4 text-slate-600 dark:text-navy-100"
							...
							<img class="h-11 w-1w"
							src="/index/resources/images/avatar/tropy icon.svg" alt="image"
							style="margin-top: 1rem;">
							<p class="text-3xl font-medium text-slate-700 dark:text-navy-100">
								${sessionScope.REWARDS }</p>
				...
				<div class="card flex-row justify-between space-x-2 p-2.5"
					...
					<div class="flex items-center justify-between">
						<div style="left: -1rem;"
							class=" childs swiper w-64 swiper-cards swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress"
							x-init="$nextTick(()=>$el._x_swiper = new Swiper($el,{effect: 'cards'}))">
							<div class="swiper-wrapper" id="swiper-wrapper-a64f9f8ce979adad"
								aria-live="polite">
								<div class="container"
									style="top: -0.5rem; right: -0.5rem; height: 7.2rem;">
									<div class="background">
										...
										<div class="content">
											<img id="weather-icon"
												...
												alt="Weather Icon">
											<h1 class="Condition" id="description">
												<i class="material-icons sun"></i>
											</h1>
											<h3 class="Temp" id="temperature"></h3>
											<h1 class="Time" id="wind-speed"></h1>
											<h1 class="Location" id="city">
												<i class="material-icons locationIcon">place</i> Raleigh, NC
											</h1>
										</div>
									</div>
								</div>
					...
					<div class="mx-4 my-1 w-px bg-slate-200 dark:bg-navy-500"></div>
					<a href="https://heyzine.com/flip-book/8baf82e225.html"
						target="_blank" style="margin-top: 2rem;"> <img
						class="h-20 w-1w"
						src="/index/resources/images/avatar/get-newsletter-updates.svg"
						alt="image">
    ...
    width: 18rem;">
            ...
            <!--   <button class="flex h-20 w-full items-center justify-center rounded-lg bg-slate-200 dark:bg-navy-500"  :class="$store.global.isSidebarExpanded && 'active'"
				...
				<div
					class="mx-auto grid w-full max-w-4xl grid-cols-1s gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6s">
					<div class="card p-4 "
						<c:if test="${sessionScope.BASE_DEPARTMENT eq 'SCM' && sessionScope.BASE_DEPARTMENT eq 'HR'}"> style="BACKGROUND-COLOR: lavender;"</c:if>>

						<h2
							class="mt-5 text-base text-center font-medium tracking-wide text-slate-700 dark:text-navy-100">
							${sessionScope.DEPARTMENT_NAME }</h2>

						<div class="mt-5 pb-1 text-center">
							<a
								href="<%=request.getContextPath() %>/${sessionScope.BASE_DEPARTMENT }"
								class="text-xs text-success">My Department</a>
						</div>
					</div>
					<div class="card p-4 "
						<c:if test="${sessionScope.BASE_DEPARTMENT ne 'SCM' }"> style="BACKGROUND-COLOR: lavender;"</c:if>
						:class="$store.global.isRightSidebarExpanded &amp;&amp; 'active'"
						@click="$store.global.isRightSidebarExpanded = !$store.global.isRightSidebarExpanded">

						<h2
							class="mt-5 text-base text-center font-medium tracking-wide text-slate-700  dark:text-navy-100">Happenings
