      ...
      <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="relative flex flex-col items-center justify-center">
          <div class="absolute right-0 top-0 -mt-8 hidden max-w-xs p-4 lg:block">
            <img src="/index/resources/images/illustrations/help.svg" alt="image">
          </div>
          ...
          <div class="relative mt-6 w-full max-w-md">
            ...
            <div class="absolute left-0 top-0 flex h-12 w-10 items-center justify-center text-slate-400 peer-focus:text-re dark:text-navy-300 dark:peer-focus:text-accent">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="#e21e26">
          ...
          <div class="space-y-20">
            <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
              <div class="flex justify-center">
                <img class="w-full max-w-xs" src="/index/resources/images/illustrations/rocket.svg" alt="image">
              </div>
              <div class="w-full">
                ...
                <div x-data="{expandedItem:'item-1'}" class="mt-3 flex w-full flex-col divide-y divide-indigo-400 overflow-hidden rounded-lg border border-primary dark:border-accent">
                  <div x-data="accordionItem('item-1')">
                    <div @click="expanded = !expanded" class="flex cursor-pointer items-center justify-between bg-primary px-4 py-4 text-base font-medium text-white dark:bg-accent sm:px-5">
                      <p>Question 1</p>
                      <div :class="expanded &amp;&amp; '-rotate-180'" class="text-sm font-normal leading-none text-indigo-100 transition-transform duration-300 -rotate-180">
                    ...
                    <div x-collapse="" x-show="expanded">
                      <div class="px-4 py-4 sm:px-5">
                        ...
                        <div class="mt-2 flex space-x-2">
                          <a href="#" class="tag rounded-full border border-primary text-re dark:border-accent-light dark:text-accent-light">
                            Tag 1
                          </a>
                          <a href="#" class="tag rounded-full border border-primary text-re dark:border-accent-light dark:text-accent-light">
                            Tag 2
            ...
            <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
              <div class="flex justify-center lg:order-last">
                <img class="w-full max-w-xs" src="/index/resources/images/illustrations/mobile-app.svg" alt="image">
              </div>
              <div class="w-full">
                <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
                  Mobile App
                ...
                <div x-data="{expandedItem:'item-1'}" class="mt-3 flex w-full flex-col divide-y divide-yellow-400 overflow-hidden rounded-lg border border-warning">
                  <div x-data="accordionItem('item-1')">
                    <div @click="expanded = !expanded" class="flex cursor-pointer items-center justify-between bg-warning px-4 py-4 text-base font-medium text-white sm:px-5">
                      <p>Question 1</p>
                      <div :class="expanded &amp;&amp; '-rotate-180'" class="text-sm font-normal leading-none text-yellow-100 transition-transform duration-300 -rotate-180">
                        <i class="fas fa-chevron-down"></i>
                      </div>
                    </div>
                    <div x-collapse="" x-show="expanded">
                      <div class="px-4 py-4 sm:px-5">
                        ...
                        <div class="mt-2 flex space-x-2">
                          <a href="#" class="tag rounded-full border border-warning text-warning">
                            Tag 1
                          </a>
                          <a href="#" class="tag rounded-full border border-warning text-warning">
                            Tag 2
            ...
            <div class="grid grid-cols-1 place-items-center gap-10 lg:grid-cols-2">
              <div class="flex justify-center">
                <img class="w-full max-w-xs" src="/index/resources/images/illustrations/credit-card.svg" alt="image">
              </div>
              <div class="w-full">
                <h4 class="text-lg font-medium text-slate-700 dark:text-navy-100">
                  Payments
                ...
                <div x-data="{expandedItem:'item-1'}" class="mt-3 flex w-full flex-col divide-y divide-sky-400 overflow-hidden rounded-lg border border-info">
                  <div x-data="accordionItem('item-1')">
                    <div @click="expanded = !expanded" class="flex cursor-pointer items-center justify-between bg-info px-4 py-4 text-base font-medium text-white sm:px-5">
                      <p>Question 1</p>
                      <div :class="expanded &amp;&amp; '-rotate-180'" class="text-sm font-normal leading-none text-sky-100 transition-transform duration-300 -rotate-180">
                        <i class="fas fa-chevron-down"></i>
                      </div>
                    </div>
                    <div x-collapse="" x-show="expanded">
