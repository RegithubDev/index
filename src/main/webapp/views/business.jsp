...
"> <img class="h-20 w-1w" src="/index/resources/images/avatar/get-newsletter-updates.svg" alt="image">
    ...
    width: 18rem;">
        ...
        <div class="mx-auto grid w-full max-w-4xl grid-cols-1s gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6s">
          <div class="card p-4 " 	<c:if test="${sessionScope.BASE_DEPARTMENT eq 'BD' && sessionScope.BASE_DEPARTMENT eq 'HR'}"> style="BACKGROUND-COLOR: lavender;"</c:if>>
          ...
          <div class="card p-4 "
          <c:if test="${sessionScope.BASE_DEPARTMENT ne 'BD' }"> style="BACKGROUND-COLOR: lavender;"</c:if>
           :class="$store.global.isRightSidebarExpanded &amp;&amp; 'active'" @click="$store.global.isRightSidebarExpanded = !$store.global.isRightSidebarExpanded">
            ...
            <h2 class="mt-5 text-base text-center font-medium tracking-wide text-slate-700  dark:text-navy-100">Happenings @ Business Development</h2>
